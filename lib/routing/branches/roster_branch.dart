...
final rosterBranch = StatefulShellBranch(routes: [
  GoRoute(
    path: '/rosters',
    name: 'rosters',
    builder: (c, s) => const RostersScreen(),
    routes: [
      GoRoute(path: 'import', name: 'rosterImport', builder: (c, s) => RosterImportScreen(teamId: s.extra is String ? s.extra as String : null)),
    ],
  ),
  GoRoute(
