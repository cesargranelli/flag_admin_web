...
final organizationBranch = StatefulShellBranch(
  routes: [
    GoRoute(
      path: '/organizations',
      name: 'organizations',
      ...
      routes: [
        GoRoute(
          ...
          builder: (c, s) => const OrganizationCreateScreen(),
        ),
        GoRoute(
          path: ':id',
          name: 'organizationDetail',
          builder: (c, s) {
            final org = s.extra is Organization
                ? s.extra as Organization
                : null;
            return OrganizationDetailScreen(
              organizationId: s.pathParameters['id'],
              organization: org,
            );
          },
          routes: [
