...
class RoundEditScreen extends ConsumerStatefulWidget {
  const RoundEditScreen({super.key, required this.roundId, this.round});

  final String roundId;
  final Round? round;

  @override
  ConsumerState<RoundEditScreen> createState() => _RoundEditScreenState();
}

class _RoundEditScreenState extends ConsumerState<RoundEditScreen> {
  final _formKey = GlobalKey<FormState>();

  late final TextEditingController _name;
  late final TextEditingController _number;
  late RoundEditViewModel _viewModel;
  ...
  void initState() {
    ...
    _viewModel = ref.read(roundEditViewModelProvider(widget.roundId));
    WidgetsBinding.instance.addPostFrameCallback((_) {
      final round = widget.round;
      if (round != null) {
        _viewModel.init(round);
        _name.text = round.name;
        _number.text = round.number.toString();
      }
    });
  }
