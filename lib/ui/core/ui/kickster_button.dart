...
class KicksterButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final foreground = switch (variant) {
      ...
      KicksterButtonVariant.text => AppColors.primary,
    };
    final child = Row(
    ...
    final style = _kicksterStyle(
      ...
      side: switch (variant) {
        KicksterButtonVariant.outline => const BorderSide(
          color: AppColors.primary,
        ),
        KicksterButtonVariant.dangerOutline => const BorderSide(
    ...
    return switch (variant) {
      ...
      KicksterButtonVariant.outline ||
      KicksterButtonVariant.dangerOutline => OutlinedButton(
        onPressed: enabled ? onPressed : null,
        style: style,
        child: child,
      ),
