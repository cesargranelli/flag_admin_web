...
class _KicksterCalendarState extends State<KicksterCalendar> {
  ...
  bool get _canGoToPreviousYearPage => _yearPageStart > widget.firstDate.year;

  bool get _canGoToNextYearPage => _yearPageStart + 11 < widget.lastDate.year;
    ...
    return SizedBox(
      ...
      child: GridView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          final enabled =
              !endOfMonth.isBefore(widget.firstDate) &&
  ...
  List<Widget> _buildWeekRows() {
    ...
    final cells = <DateTime>[
      ...
      for (var i = 1; i <= trailingDays; i++) DateTime(year, month + 1, i),
    ];
  ...
  Widget _buildDayCell(DateTime date) {
    ...
    if (!inMonth || !enabled) {
      ...
      cell = Semantics(
        button: true,
        selected: isSelected,
        label: '${date.day} de ${_kMonthNames[date.month - 1]} de ${date.year}',
        child: cell,
      );
    }
