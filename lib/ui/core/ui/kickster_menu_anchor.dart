...
class _KicksterMenuOverlayState extends State<_KicksterMenuOverlay> {
  final FocusScopeNode _scopeNode = FocusScopeNode(
    debugLabel: 'KicksterMenuAnchor menu',
  );
  ...
  Widget build(BuildContext context) {
    ...
    final naturalHeight =
        estimatedItemCount * 48.0 + (estimatedItemCount - 1) * 1.0 + 2.0;
    final effectiveMaxHeight = widget.maxHeight ?? naturalHeight;

    // Espaço disponível abaixo do anchor
    final spaceBelow =
        availableScreenBottom - (widget.anchorTop + widget.anchorHeight + 8);
