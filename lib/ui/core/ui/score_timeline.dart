...
class ScoreTimeline extends StatelessWidget {
  const ScoreTimeline({super.key, required this.game, required this.events});
  ...
  Widget _eventBadge(bool isHome, int minute) {
    ...
    return Semantics(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: (isHome ? AppColors.primary : AppColors.success).withValues(
            alpha: 0.1,
          ),
