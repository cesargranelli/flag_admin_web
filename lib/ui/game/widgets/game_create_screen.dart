...
/// Argumentos de navegação do formulário de criação de jogo.
typedef GameCreateArgs = ({String? competitionId, String? roundId});

/// Formulário de criação de jogo.
class GameCreateScreen extends ConsumerStatefulWidget {
  const GameCreateScreen({super.key, this.args});

  final GameCreateArgs? args;
...
class _GameCreateScreenState extends ConsumerState<GameCreateScreen> {
  ...
  late GameCreateViewModel _viewModel;
  late final TextEditingController _scheduleController;

  @override
  void initState() {
    super.initState();
    _viewModel = ref.read(gameCreateViewModelProvider);
    _scheduleController = TextEditingController();
    WidgetsBinding.instance.addPostFrameCallback((_) {
      final competitionId =
          widget.args?.competitionId ?? ref.read(selectedCompetitionProvider);
      if (competitionId != null) {
        _viewModel.init(
          competitionId: competitionId,
          roundId: widget.args?.roundId,
        );
