...
class _CompetitionDetailScreenState
  ...
  Widget build(BuildContext context) {
        ...
        body: Center(
          child: Column(
            ...
            children: [
              ...
              KicksterButton(label: 'Voltar', onPressed: () => context.pop()),
            ],
          ),
        ),
      );
    ...
    final matchedOrg = orgs
        ...
        .firstOrNull;
    final orgName =
        (comp.organizationName != null &&
            comp.organizationName!.trim().isNotEmpty)
                    ...
                    KicksterButton(
                      ...
                      onPressed: () async {
                        ...
                        if (context.mounted) {
                          ref
                              .read(
                                competitionDetailViewModelProvider(widget.id),
                              )
                              .load(forceRefresh: true);
                        }
                      },
                    ...
                    children: [
                      ...
                      if (comp.groupingConfig != null &&
                        ...
                        if (comp.groupingType == GroupingType.groups)
                          ...
                          Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: comp.groupingConfig!.conferences.map((c) {
                              return Padding(
                ...
                if (canWrite)
                  if (isOpen)
                    KicksterButton(
                      ...
                      onPressed: () async {
                        final ok = await showKicksterConfirm(
                          ...
                          content:
                              'Deseja encerrar o período de inscrição de equipes para esta competição?',
                    ...
                    KicksterButton(
                      ...
                      variant: KicksterButtonVariant.outline,
                      onPressed: () =>
                          _showOpenEnrollmentWindowModal(context, vm),
                    ),
              ],
            ),
          ],
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    KicksterInput(
                      ...
                      maxLines: 3,
                      hintText:
                          'Ex: Equipes devem apresentar elenco mínimo de 10 atletas.',
                    ),
                  ],
                ),
              ),
